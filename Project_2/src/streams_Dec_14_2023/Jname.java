...
import streams_Dec_13_2023.Student;
...
public class Jname {
	...
	public static void main(String[] args) {
			...
			value.add(new Student(2, "jaimuni", "male", "ece", "nellore,1234", "Chinthala", "AP"));
			...
			value.stream().filter(male->male.getGender().equals("male")).filter(name->name.getName().startsWith("j"))
