...
public class Program3 {
	...
	public static void main(String[] args) {
		...
		value.add(new Student(5, "vaishali", "female", "cse", "srikakulam,234", "bapatla", "AP"));
		List item2 = value.stream().filter(e -> e.getDepartment().equals("cse")).collect(Collectors.toList());
